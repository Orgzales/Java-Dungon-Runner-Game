...
public class Unity extends JFrame
{
    ...
    public GridBagConstraints gbc(int gridx, int gridy, int fill, int ipadx, int ipady, int weightx, int weighty, int gridwidth, int gridheight, Insets spacer)
    {
        this.gbc.gridx = gridx;
        this.gbc.gridy = gridy;
        this.gbc.fill = fill;
